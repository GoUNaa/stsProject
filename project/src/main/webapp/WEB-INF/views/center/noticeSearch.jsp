...
<c:forEach var="bb" items="${bb }">

<tr>
<td>${bb.num}</td> <td><a href='<c:url value="/board/content?num=${bb.num}"/>'>${bb.subject}</a></td>
<td>${bb.name}</td><td>${bb.readcount}</td>
...
<div id="table_search">
<form action='<c:url value="/board/listSearch"/>' method="post" class="search">
<input type="text" name="search" class="input_box" value="${pbBean.search}"><br>
