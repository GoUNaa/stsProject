...
<a href =' <c:url value="/main/map" />' style="text-decoration:none">부산광역시 부산진구 동천로 109 삼한골든게이트 7층</a></div>
...
if(id != null){
%><a href='<c:url value="/main/mail" />'><img src='<c:url value="/resources/images/mail.png" />' width="34" height="34" alt="mail" style="cursor: pointer"></a>
	<%
}
%>
</div>
